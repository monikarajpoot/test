...
class Tank_auth
{
	...
	function __construct()
	{
		...
		$this->ci->load->model('users/auth_users_model');
	...
	/**
	 * Create new user with Oauth2 on the site and return some data about it:
	 * user_id, email, provider, firstname, lastname.
	 *
	 * @param	string
	 * @param	string
	 * @param	string
	 ...
	 * @return	array
	 */
	function create_user_oa2($email, $provider, $firstname, $lastname)
	{
