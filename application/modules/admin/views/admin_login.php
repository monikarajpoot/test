  ...
  <body class="login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <form action="<?php echo base_url();?>admin/admin_auth/" method="post" id="login-form">
          <?php if(validation_errors() != "") {?>
              <div class="alert alert-danger alert-dismissable">
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                  <strong><?php echo 'Warning alter!';?></strong><br>
                  <?php echo validation_errors(); ?>
              </div>
          <?php }?>
          <div class="form-group has-feedback">
            <!-- <input type="email" class="form-control" placeholder="Email"/> -->
            <input type="text"  name="username" id="username" class="form-control" required placeholder="<?php echo 'Admin login Id';?>" >
            <span class="glyphicon glyphicon-envelope form-control-feedback"><?php //echo form_error('username');?></span>
			
          </div>
          <div class="form-group has-feedback">
            <input type="password" name="password" id="password" required class="form-control" placeholder="<?php echo 'Password';?>">
            <span class="glyphicon glyphicon-lock form-control-feedback"><?php //echo form_error('password');?></span>
          </div>
          <div class="row">
            <div class="col-xs-8">    
                 <a href="javascript:void(0);" onclick="forgotpassword();"><?php echo 'Forgot Password';?></a><br>               
            </div><!-- /.col -->
            <div class="col-xs-4">
              <button type="submit" class="btn btn-primary btn-block btn-flat"><?php echo 'Submit';?></button>
            </div><!-- /.col -->
          </div>
        </form>
        <form  id="forgot-form" style="display:none;" action="<?php echo base_url();?>admin/admin_auth/forgote_password" method="post">
                <div class="form-group has-feedback">
                  <input type="email" name="email" id="email" class="form-control" placeholder="<?php echo 'Admin Email'?>" >
                ...
                <div class="row">
                  <div class="col-xs-6">    
                       <a href="javascript:void(0);" onclick="login();"><?php echo 'Login';?></a><br>               
                  </div><!-- /.col -->
                  <div class="col-xs-6">
                    <button type="submit" class="btn btn-primary btn-block btn-flat" onclick="return valForgot();" name="forgotpassword" type="submit"><?php echo 'Forgote Password ';?></button>
                  </div><!-- /.col -->
                </div>
               <!--  <label >
