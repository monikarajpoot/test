                    ...
                    <div class="box-body">
                        ...
                        <div class="col-lg-6 col-xs-6">
                            <table class="table table-condensed">
                                ...
                                <tr>
                                    <td>
                                       <label> Parent name/ Husband </label> 
                                    </td>
                                    <td>
								...
								<tr>
                                    <td>
                                       <label> Service Book Copy </label> 
                                    </td>
                                    <td>
                                        <b><?php $service_book = get_service_record($this->session->userdata('emp_id')); ?></b>
                                    </td>
                                </tr>
                        ...
                        <div class="col-lg-6 col-xs-6">
                            <table class="table table-condensed">
                                ...
                                <tr>
                                    <td>
                                       <label>  Date of govt joining  </label> 
                                    </td>
                                    <td>
