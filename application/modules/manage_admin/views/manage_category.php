...
<section class="content">
    ...
    <div class="row">
				...
				<form action="<?php echo base_url();?>manage_admin/add_menus" id="for_menu" method="post">
                        <div class="row">
                            ...
                            <div class="col-xs-3">
                                ...
                                <option value="0">-- For Parent Category -- </option>						
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <div style="float:left"><h3 class="box-title"><?php echo $sub_title_tab;?></h3></div>
                </div><!-- /.box-header -->
                    ...
                    <table id="example36" class="table table-bordered table-striped">
                        ...
                        <?php $i=1; foreach($get_menu as $key => $menu) { ?>
                            <tr>
                                ...
                                <td><?php  echo ($menu['parent_nm']?$menu['parent_nm']:'Parent Category');?></td>
