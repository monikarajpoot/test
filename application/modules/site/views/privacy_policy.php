<div class="breadcrumbs">
		<div class="container">
			<ol data-wow-delay=".5s" class="breadcrumb breadcrumb1 animated wow slideInLeft animated" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInLeft;">
				<li><a href="<?php echo base_url();?>"><span aria-hidden="true" class="glyphicon glyphicon-home"></span>Home</a></li>
				<li class="active"><?php echo ucwords(end($this->uri->segments));?></li>
			</ol>
		</div>
	</div>
